...
static const char *fonts[]          = { "monospace:size=10", "JetBrainsMonoNL NF:size=12" };
static const char dmenufont[]       = "JetBrainsMonoNL NF:size=12";
static const char normbg[]          = "#282828";
static const char normborder[]      = "#282828";
static const char normfg[]          = "#ebdbb2";
static const char selfg[]           = "#fbf1c7";
static const char selbg[]           = "#665c54";
static const char selborder[]       = "#d5c4a1";
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_e,      spawn,          SHCMD("kitty --hold fish -C y") },
        { Mod4Mask|ShiftMask,           XK_s,      spawn,          SHCMD("flameshot gui") },
        { Mod4Mask|ShiftMask,           XK_l,      spawn,          SHCMD("slock") },
	{ MODKEY,                       XK_r,      spawn,          SHCMD("~/.dotfiles/scripts/shift t") },
